"""Configure pytest for e2e tests — HA stubs only, real aiohttp."""
import sys
import os
...
# ---------------------------------------------------------------------------
# Patch sys.modules — NOTE: aiohttp is intentionally NOT mocked here
# so that e2e tests make real HTTP requests to the NEA API.
# ---------------------------------------------------------------------------
sys.modules.update({
